...
<body>
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="mainNav">
        <ul class="navbar-nav ms-auto mb-2 mb-lg-0 me-3">
          ...
          <li class="nav-item"><a class="nav-link" href="shree-niwasa-homestay-gallery.php">Gallery</a></li>
      ...
      <div class="row">
        ...
        <div class="col-md-4 mb-4">
          ...
          <ul class="list-unstyled small">
            ...
            <li class="mb-2"><a href="shree-niwasa-homestay-gallery.php"
                class="text-secondary text-decoration-none">Home Gallery</a></li>
  ...
  <nav class="mobile-bottom-nav d-lg-none">
    ...
    <a href="shree-niwasa-homestay-gallery.php" class="nav-item">
