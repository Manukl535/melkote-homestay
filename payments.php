...
<body>
    ...
    <div class="container">
        <div class="card p-4 text-center">
            ...
            <div class="price-box my-3">
                <strong>₹4999</strong> Per Day × Stay Duration
            </div>

            <form method="POST">
                <input type="tel" name="phone" class="form-control mb-3" placeholder="Enter registered phone number"
                    required>
    ...
    <a href="https://wa.me/+919008288474" class="whatsapp" target="_blank">
